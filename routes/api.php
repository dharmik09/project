...
Route::group([ 'middleware' => ['api-support'] ], function () {
	...
	Route::post('/sendReferenceIdToParentsAndMentors', 'Webservice\ProfileController@sendReferenceIdToParentsAndMentors');
	...
	Route::post('/getLevel1TeenagerTraits', 'Webservice\Level1ActivityController@getLevel1TeenagerTraits');
	...
	Route::post('/getCareersByMatchScale', 'Webservice\level3ActivityController@getCareersByMatchScale');
	Route::post('/getCareerPdf', 'Webservice\level3ActivityController@getCareerPdf');
	...
	//L4 Promise Plus 
	Route::post('/getLevel4PromisePlusDetails', 'Webservice\Level4ActivityController@getLevel4PromisePlusDetails');

	//L4 Basic Question Answer
	Route::post('/getLevel4BasicQuestions', 'Webservice\Level4ActivityController@getLevel4BasicQuestions');
	Route::post('/saveLevel4BasicQuestions', 'Webservice\Level4ActivityController@saveLevel4BasicQuestions');
	...
	Route::post('/getProfessionL4Pointpoints', 'Webservice\Level4ActivityController@getProfessionL4Pointpoints');
