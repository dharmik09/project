            ...
            <div class="article-que">
                ...
                <ul class="social">
                   <li>Share :</li>
                    ...
                    <li><a href="http://twitter.com/intent/tweet?status={{$metaTitle}}+&nbsp;,&nbsp;+{{url($metaDescription)}}+&nbsp;+@ProTeenLife" target="_blank" title="Twitter"><i class="icon-twitter"></i></a></li>
                    <li><a href="https://plus.google.com/share?url={{url($siteUrl)}}" target="_blank" title="Google plus"><i class="icon-google"></i></a></li>
                    <li><a href="http://www.linkedin.com/shareArticle?mini=true&url={{url($siteUrl)}}&title={{$metaTitle}}&source={{url($siteUrl)}}" target="_blank" title="Linkedin"><i class="icon-linkdin"></i></a></li>
                </ul>
            </div>
