                                            ...
                                            @forelse($teenagerStrength as $key => $value)
                                                <div class="progress-block">
                                                    ...
                                                    <div class="progress {{$exceedClass}}">
                                                        ...
                                                        <div class="progress-bar bg-success" role="progressbar" style="width: {{round($value['lowscoreH'])}}%; background-color:rgb(101, 198, 230,1.0);" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                            @empty
                                            <div class="progress-block">
...
<script>
    ...
    // $( "#socialShare" ).mouseover(function() {
