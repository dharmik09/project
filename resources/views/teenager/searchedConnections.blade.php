                        ...
                        <div class="team-list">
                            ...
                            <div class="flex-item">
                                <div class="team-point">
                                    ...
                                    <a href="{{ url('teenager/network-member') }}/{{$newConnection->t_uniqueid}} " data-placement="bottom" title="Please make a connection to chat" data-toggle="tooltip" ><i class="icon-chat"><!-- --></i></a>
                                </div>
                            </div>
                        </div>
                        @empty
