...
<div class="rank_local">
    <span style="font-size: 14px;"><?php echo ($teenagerId == Auth::guard('teenager')->user()->id)?"My":''; ?> Rank : {{$response['rank']}}</span>
    <span style="font-size: 14px;"><?php echo ($teenagerId == Auth::guard('teenager')->user()->id)?"My":''; ?> Points : {{$response['yourscore']}}</span>
</div>
