            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                            ...
                            <li class="{{ (Request::is('admin/baskets') || Request::is('admin/addBasket') || Request::is('admin/editBasket/*') || Request::is('admin/saveBaskets') ||Request::is('admin/deleteBaskets') || Request::is('admin/professions') || Request::is('admin/addProfessions') || Request::is('admin/editProfessions/*') || Request::is('admin/saveProfessions') || Request::is('admin/deleteProfessions/*') || Request::is('admin/addProfessionBulk') || Request::is('admin/saveProfessionBulk') || Request::is('admin/exportProfessoin') || Request::is('admin/exportCompetitors') || Request::is('admin/headers') || Request::is('admin/addHeader') || Request::is('admin/editHeader/*') || Request::is('admin/deleteHeader') || Request::is('admin/deleteHeader/*') || Request::is('admin/careerMapping') || Request::is('admin/addCareerMapping') || Request::is('admin/editCareerMapping/*') || Request::is('admin/saveCareerMapping') || Request::is('admin/deleteCareerMapping/*') || Request::is('admin/importExcel') || Request::is('admin/addImportExcel') || Request::is('admin/professionCertifications') || Request::is('admin/professionSubjects') || Request::is('admin/professionTags') || Request::is('admin/addProfessionTag') || Request::is('admin/editProfessionTag/*') || Request::is('admin/saveProfessionTag') || Request::is('admin/deleteProfessionTag/*')) ? 'active' : '' }} treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li class="{{ (Request::is('admin/baskets') || Request::is('admin/addBaskets') || Request::is('admin/editBaskets/*') || Request::is('admin/saveBaskets') || Request::is('admin/deleteBaskets')) ? 'active' : '' }}">
                                        ...
                                        <li class="{{ (Request::is('admin/professions') || Request::is('admin/addProfessions') || Request::is('admin/editProfessions/*') || Request::is('admin/saveProfessions') || Request::is('admin/deleteProfessions/*') || Request::is('admin/headers') || Request::is('admin/addHeaders') || Request::is('admin/editHeaders/*') || Request::is('admin/saveHeaders') || Request::is('admin/deleteHeaders/*') || Request::is('admin/careerMapping') || Request::is('admin/professionCertifications') || Request::is('admin/professionSubjects') || Request::is('admin/professionTags') || Request::is('admin/addProfessionTag') || Request::is('admin/editProfessionTag/*') || Request::is('admin/saveProfessionTag') || Request::is('admin/deleteProfessionTag/*')) ? 'active' : '' }}">
                                        <a href="{{ url('admin/professions') }}">
                                            <i class="{{ (Request::is('admin/professions') || Request::is('admin/addProfessions') || Request::is('admin/editProfessions/*') || Request::is('admin/saveProfessions') || Request::is('admin/deleteProfessions/*') || Request::is('admin/headers') || Request::is('admin/addHeaders') || Request::is('admin/editHeaders/*') || Request::is('admin/saveHeaders') || Request::is('admin/deleteHeaders/*') || Request::is('admin/careerMapping') || Request::is('admin/professionCertifications') || Request::is('admin/professionSubjects') || Request::is('admin/professionTags') || Request::is('admin/addProfessionTag') || Request::is('admin/editProfessionTag/*') || Request::is('admin/saveProfessionTag') || Request::is('admin/deleteProfessionTag/*')) ? 'fa fa-dot-circle-o' : 'fa fa-circle-o' }}"></i>{{trans('labels.professions')}}<i class="fa fa-angle-left pull-right"></i>
                                        </a>
                                        <ul class="treeview-menu">
                            ...
                            <li class="{{ in_array(Route::getFacadeRoot()->current()->uri(), ['admin/level4Activity', 'admin/viewUserAllAdvanceActivities/{teenager}/{profession}', 'admin/level4Activity', 'admin/level4AdvanceActivityUserTask', 'admin/editlevel4advanceactivity/{id}', 'admin/listlevel4advanceactivity', 'admin/editlevel4IntermediateActivity/{id}', 'admin/listLevel4IntermediateActivity', 'admin/editGamificationTemplate/{id}', 'admin/listGamificationTemplate', 'admin/editLeve4Activity/{id}', 'admin/addLevel4Activity', 'admin/editLevel4Activity', 'admin/level4LearningStyle', 'admin/level4AdvanceActivityParentTask', 'admin/professionLearningStyle', 'admin/addProfessionLeaningStyle', 'admin/editProfessionLearningStyle/{id}', 'admin/importLearningStyle' ]) ? 'active' : '' }} treeview">
