                    ...
                    <ul class="nav-bar clearfix">
                        ...
                        <li class="n-coin submenu-container">
                            <a href="javascript:void(0);">
                                ...
                                <span id="user_procoins">{{ (Auth::guard('sponsor')->user()->sp_credit > 0) ? number_format(Auth::guard('sponsor')->user()->sp_credit) : 'No Coins' }}</span>
                            </a>
                            <div class="submenu">
                                <h2>My ProCoins</h2>
                                <div class="btns">
                                    <a href="{{ url('/sponsor/my-coins') }}" class="btn btn-success btn-small text-uppercase">Buy</a>
                                    <a href="{{ url('/sponsor/get-consumption') }}" class="btn btn-success btn-small text-uppercase">History</a>
                                </div>
                            </div>
                        </li>
