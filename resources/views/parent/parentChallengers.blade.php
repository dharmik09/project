                ...
                <li>
                    <div class="vs_box">
                        ...
                        <div class="research clearfix">
                            ...
                            <a href="{{url('/parent/career-detail')}}/{{$value->pf_slug}}/{{$value->t_uniqueid}}" class="research btn primary_btn">Research</a>
                            <a href="{{url('/parent/career-detail')}}/{{$value->pf_slug}}/{{$value->t_uniqueid}}" class="btn primary_btn">  Accept </a>
                        </div>
                    </div>
                </li>
            @empty
