<input type="hidden" value="{{$response['basicCompleted']}}" class="basicCompleted">
            ...
            <div class="cong-block">
                <div class="row">
                    ...
                    <div class="col-xs-8">
                        ...
                        <p><strong>{{ ucwords($response['parentName']) }} !</strong> You are now a rookie ProTeen {{$response['professionName']}}.</p>
