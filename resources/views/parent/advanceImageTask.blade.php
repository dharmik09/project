...
@if(isset($userLevel4AdvanceImageTask) && !empty($userLevel4AdvanceImageTask))
...
<?php $pendingTask = 0; ?>
    ...
    <?php 
        if(isset($task->l4aapa_media_name) && $task->l4aapa_media_name != '') {
            $image =  Storage::url($level4AdvanceThumbImageUploadPath.$task->l4aapa_media_name);
            $originalImage =  Storage::url($level4AdvanceOriginalImageUploadPath.$task->l4aapa_media_name);
        }else{
            $image =  Storage::url($level4AdvanceThumbImageUploadPath.'proteen-logo.png');
            $originalImage =  Storage::url($level4AdvanceOriginalImageUploadPath.'proteen-logo.png');
        }
    ?>
    ...
    @endif
        <li>
            <div class="upd_detail clearfix img_type">
                <div class="img_cont">
                    <div class="img_inner" onclick="viewLargeImage('{{$originalImage}}')">
                        <img src="{{$image}}">
