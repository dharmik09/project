            ...
            <div class="box box-primary">
               <div>
                    ...
                    <!--<ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#image_tab" aria-controls="image_tab" role="tab" data-toggle="tab">Image</a></li>
                        <li role="presentation"><a href="#document_tab" aria-controls="document_tab" role="tab" data-toggle="tab">Document</a></li>
                        <li role="presentation"><a href="#video_tab" aria-controls="video_tab" role="tab" data-toggle="tab">Video</a></li>
                    </ul>-->
               </div>
                    ...
                    <div role="tabpanel" id="image_tab" class="tab-pane fade {{(isset($typeId) && $typeId == 3)?'in active':''}}">
                        <div class="box-body">
                            ...
                            @foreach($userAllImageTasks as $task)
                             <?php
                                if(File::exists(public_path($level4AdvanceThumbImageUploadPath.$task->l4aaua_media_name)) && $task->l4aaua_media_name != '') {
                                    $Originalimage =  url($level4AdvanceOriginalImageUploadPath.$task->l4aaua_media_name);
                                    $image =  url($level4AdvanceThumbImageUploadPath.$task->l4aaua_media_name);
                                }else{
                    ...
                    <div role="tabpanel" id="document_tab" class="tab-pane fade {{(isset($typeId) && $typeId == 2)?'in active':''}}">
                        @if(isset($userAllDocumentTasks) && !empty($userAllDocumentTasks))
                            ...
                            @forelse($userAllDocumentTasks as $task)
                             <?php
                                if(File::exists(public_path($level4AdvanceOriginalImageUploadPath.$task->l4aaua_media_name)) && $task->l4aaua_media_name != '') {
                                    ...
                                    $documentPath = url($level4AdvanceOriginalImageUploadPath.$task->l4aaua_media_name);
                                }else{
                            ...
                            <div class="box-footer">
                                <?php
                                    $disable = '';
                                    if ($userAllDocumentTasks[0]->l4aaua_is_verified != 1) { $disable = 'disabled'; } ?>
                       ...
                       @if(isset($userAllVideoTasks) && !empty($userAllVideoTasks))
                            ...
                            <?php
                                if(File::exists(public_path($level4AdvanceOriginalImageUploadPath.$task->l4aaua_media_name)) && $task->l4aaua_media_name != '') {
                                    ...
                                    $videoPath = url($level4AdvanceOriginalImageUploadPath.$task->l4aaua_media_name);
                                }else{
                            ...
                            <div class="box-footer">
                                <?php
                                    $disable = '';
                                    if ($userAllVideoTasks[0]->l4aaua_is_verified != 1) { $disable = 'disabled'; } ?>
                                <button type="submit" class="btn btn-primary btn-flat" <?php echo $disable;?>>{{trans('labels.savebtn')}}</button>
                            </div>
                            </form>
                            @else
