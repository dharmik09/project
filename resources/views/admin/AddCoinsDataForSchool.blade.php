<?php
        ...
        $html .= '<form id="addCoins" class="form-horizontal" method="post" action="'. url('/admin/save-coins-data-for-school').'">';
        $html .= '<input type="hidden" name="_token" value="'.csrf_token().'">';
        $html .= '<input type="hidden" name="id" value="'. $schoolDetail->id .'">';

        $html .= '<div class="form-group">';
        $html .= '<label for="t_coins" class="col-sm-3 control-label">Existing Procoins</label>';
        $html .= '<div class="col-sm-6">';
        $html .= '<span>'.$schoolDetail->sc_coins.'</span>';
        $html .= '</div>';
        $html .= '</div>';
        ...
        $html .= '<div class="col-sm-6">';
        $html .= '<span>'.$schoolDetail->sc_name.'</span>';
        $html .= '</div>';
        $html .= '</div>';
        ...
        $html .= '<div class="col-sm-6">';
        $html .= '<span>'.$schoolDetail->sc_email.'</span>';
        $html .= '</div>';
        $html .= '</div>';

        $html .= '<div class="form-group">';
        $html .= '<label for="sc_coins" class="col-sm-3 control-label">Enter ProCoins</label>';
        $html .= '<div class="col-sm-6">';
        $html .= '<input type="text" class="form-control numeric" id="sc_coins" name="sc_coins" placeholder="Enter ProCoins" value=""/>';
        $html .= '</div>';
        $html .= '</div>';
