...
<section class="content-header">
    <h1>
        Export {{trans('labels.professions')}} Data
    </h1>
</section>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Select country for which you want to export profession data</h3>
                </div><!-- /.box-header -->
                @if (count($errors) > 0)
                ...
                <form id="addProfessionBulk" class="form-horizontal" method="post" files="true" action="{{ url('/admin/exportProfessoin') }}" enctype="multipart/form-data">
                    ...
                    <div class="box-footer">
                        <button type="submit" id="submit" class="btn btn-primary btn-flat" >Export</button>
