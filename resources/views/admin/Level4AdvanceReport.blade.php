...
<section class="content"> 
    <div class="row">
        <div class="box box-info">
            <form id="level4AdvanceReport" class="form-horizontal" action="{{url('admin/level4AdvanceReport/')}}" method="post">
...
<script type="text/javascript">
    ...
    var chartData = <?php echo $advanceData; ?>;
    var totaladvancePoint = <?php echo $totaladvancePoint; ?>;
    var displayMsg = 'test';
    ...
    var displayMsg = 'test';
    var subtitle = 'Total Advance point : '+totaladvancePoint+'<br/>Total Teenagers:'+totalTeen+'<br/>';
