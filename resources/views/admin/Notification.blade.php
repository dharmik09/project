    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <form onsubmit="return fetch_checkbox(this);" id="Notification" class="form-horizontal" name="Notification" method="post" action="{{ url('/admin/sendnotification') }}" enctype="multipart/form-data">
