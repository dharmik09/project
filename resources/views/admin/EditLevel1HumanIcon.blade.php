                            ...
                            <div class="col-sm-2">
                                ...
                                <?php
                                    if (isset($id) && $id != '0' && isset($humanThumbPath)) {
                                        $image = ($hi_image != "" && Storage::disk('s3')->exists($humanThumbPath.$hi_image)) ? Config::get('constant.DEFAULT_AWS').$humanThumbPath.$hi_image : asset('/backend/images/proteen_logo.png'); ?>
