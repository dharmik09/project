        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header">
                    <form id="formSearchMultipleIntelligenceType" class="form-horizontal" method="post" action="{{ url('/developer/multipleintelligencetype') }}">
                        <div class="col-md-3">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <select id="searchBy" name="searchBy" class="form-control">
                                <option value="">{{trans('labels.formlblsearchby')}}</option>
                                <option value="mit_name" <?php if(isset($searchParamArray['searchBy']) && $searchParamArray['searchBy'] == 'mit_name'){ echo 'selected = "selected"';}?> >{{trans('labels.formlblname')}}</option>
                            </select>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-2">
                            <select id="orderBy" name="orderBy" class="form-control">
                                ...
                                <option value="mit_name" <?php if(isset($searchParamArray['orderBy']) && $searchParamArray['orderBy'] == 'mit_name'){ echo 'selected = "selected"';}?> >{{trans('labels.formlblname')}}</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-1">
                            <input type="submit" class="btn btn-primary btn-flat" name="searchMultipleIntelligenceType" id="searchMultipleIntelligenceType" value="{{trans('labels.lblsearch')}}"/>
                        </div>
                        <div class="col-md-1">
