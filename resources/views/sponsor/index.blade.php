                    ...
                    <div class="form-sec bg-enterprise">
                        ...
                        <form id="login_form" method="POST" action="{{ url('sponsor/login-check') }}" autocomplete="off">
                            ...
                            <div class="checkbox">
                                ...
                                <span class="pull-right"><a href="{{ url('sponsor/forgot-password') }}" title="Forgot username/password?">Forgot password?</a></span>
                            </div>
...
<!--        <div class="finalist-img">
    ...
    <section class="sec-masonary">
        <div class="container-large">
            <h2 class="cl-enterprise">Listen to our Community</h2>
            <div class="row">
                ...
                @if(isset($videoCount) && $videoCount > 12)
                    <p id="remove-row" class="text-center"><a id="load-more" href="javascript:void(0)" data-id="{{ $video->id }}" title="see more" class="btn btn-primary">see more</a></p>
                @endif
            </div>
        </div>
    </section>
