    ...
    <div class="container">
        <div class="clearfix col-md-offset-2 col-sm-offset-1 col-md-8 col-sm-10 detail_container">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <form id="change_password_form" role="form" method="POST" class="login_form" action="{{ url('/sponsor/update-password') }}" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">
