...
@push('script-header')
    <title>{{ trans('labels.appname') }} : Forgot Passowrd</title>
@endpush
    ...
    <div class="container">
        <div class="clearfix col-md-offset-2 col-sm-offset-1 col-md-8 col-sm-10 detail_container">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <form class="registration_form" method="POST" id="forgot-password-OTP" action="{{url('sponsor/forgot-password-OTP-verify')}}">
