            ...
            <div class="row flex-container">
                <div class="col-sm-6 flex-items order-1">
                    <div class="full-width">
                        ...
                        <div class="content">
                            <?php $arrangedText = explode("###", preg_replace("/&nbsp;/", '', $schoolText)); ?>
                    ...
                    <div class="form-sec bg-school">
                        ...
                        <form id="login_form" method="POST" action="{{ url('school/login-check') }}" autocomplete="off">
                            ...
                            <div class="checkbox">
                                ...
                                <span class="pull-right"><a href="{{ url('school/forgot-password') }}" title="Forgot username/password?">Forgot password?</a></span>
                            </div>
        ...
        <div class="container-large">
            ...
            <div class="row">
                ...
                @if(isset($videoCount) && $videoCount > 12)
                    <p id="remove-row" class="text-center"><a id="load-more" href="javascript:void(0)" title="load more" class="btn btn-primary" data-id="{{ $video->id }}">load more</a></p>
                @endif
            </div>
        </div>
    </section>
