...
class ProAptApptitudeTypes extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $sql = "CREATE TABLE IF NOT EXISTS `pro_apt_apptitude_types` (
            `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'primary key',
            `apt_name` varchar(255) NOT NULL,
            `apt_logo` varchar(100) NOT NULL,
            `apt_video` varchar(100) DEFAULT NULL,
            `ap_information` text,
